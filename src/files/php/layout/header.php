...
$logoPath = $pathFile . '/assets/images';
?>
  ...
  <div class="container">
    <div class="header__wrapper">
      <div class="header__inner">
        ...
        <img src="<?php echo $logoPath . '/logo.avif'; ?>" alt="логотип академии Андрея Андреевича Изосимова" width="50"
          height="50">
      </div>
      ...
      <div class="header__intro">
        ...
        <div class="logo">
          <img src="<?php echo $logoPath . '/logo.avif'; ?>" alt="логотип академии Андрея Андреевича Изосимова"
