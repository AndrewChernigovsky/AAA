  ...
  <div class="container">
    ...
    <ul>
      <li>
        ...
        <a class="prices__link" href="php/pages/services/audit.php">Подробнее</a>
      </li>
      <li>
        <h3 class="third-title">
          Лендинг (от 40 тыс. Р)
        ...
        <a class="prices__link" href="php/pages/services/landing.php">Подробнее</a>
      </li>
      <li>
        <h3 class="third-title">
        ...
        <a class="prices__link" href="php/pages/services/visitka.php">Подробнее</a>
      </li>
      <li>
        <h3 class="third-title">
        ...
        <a class="prices__link" href="php/pages/services/site-catalog.php">Подробнее</a>
      </li>
    </ul>
  </div>
</section>